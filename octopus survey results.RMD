...
res_ban_farming_adj = readRDS(here("results/res_farming_adj.rds"))
res_ban_sale_adj = readRDS(here("results/res_sale_adj.rds"))
res_ban_subsidies_adj = readRDS(here("results/res_subsidies_adj.rds"))
...
res_ban_farming_subgroup = readRDS(here("results/res_farming_subgroup.rds")) %>% rename(Message=tr, Country=COUNTRY)
res_ban_sale_subgroup = readRDS(here("results/res_sale_subgroup.rds")) %>% rename(Message=tr, Country=COUNTRY)
res_ban_subsidies_subgroup = readRDS(here("results/res_subsidies_subgroup.rds")) %>% rename(Message=tr, Country=COUNTRY)
...
ggplot(heat_data, aes(x = age_band, y = label, fill = representation_ratio)) +
  ...
  scale_fill_gradient2(low = "firebrick", mid = "white", high = "steelblue",
                       ...
                       name = "Survey / Census") +
  labs(
    title = "Survey Representativeness vs Census Weights\n(by Sex × Age × Country)",
